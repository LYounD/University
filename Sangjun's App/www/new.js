...
function search(){
	...
	while(true){
		...
		if(copytext.indexOf('<h3>') != -1){
			...
			var temptxt = copytext.substring
			(copytext.indexOf('<h3>')+4, 
			copytext.indexOf('</h3>'))
			
			+ copytext.substring
			(copytext.indexOf('<p>')+3, 
			copytext.indexOf('</p>'));
			...
			if( temptxt.indexOf($('#search_box').val()) != -1 ){
				comptxt 
				+= '<h3>'
				+copytext.substring(copytext.indexOf('<h3>')+4, copytext.indexOf('</h3>'))
				+'</h3>'
				+'<div class=body_label><p>'
				+copytext.substring(add_text.indexOf('<p>')+3, copytext.indexOf('</p>')) 
				+'</p></div>';
